...
def createTable():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS classes(classID INTEGER PRIMARY KEY, className TEXT, userID TEXT, invite TEXT, desc TEXT, calendar TEXT)")
    ...
    c.execute("CREATE TABLE IF NOT EXISTS posts(postID INTEGER PRIMARY KEY, classID INTEGER, submission DATETIME, duedate DATETIME, postBody TEXT, submittable INTEGER, event TEXT)")
